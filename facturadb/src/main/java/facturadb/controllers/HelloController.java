...
import facturadb.entities.Detalle;
import facturadb.entities.Factura;
import facturadb.entities.Product;
import facturadb.services.FacturaServicio;
...
public class HelloController {
	...
	public static void main(String[] ar) {
		...
		producto1.setCosto(new BigDecimal(5.6).setScale(2, RoundingMode.HALF_UP));
		producto1.setNombre("Calabaza");

		Product producto2 = new Product();
		producto2.setCosto(new BigDecimal(9.1).setScale(2, RoundingMode.HALF_UP));
		producto2.setNombre("Mango   ");

		Product producto3 = new Product();
		producto3.setCosto(new BigDecimal(8.2).setScale(2, RoundingMode.HALF_UP));
